...
**https://joe-garvin.github.io/claude-knowledge-base/**
...
This folder serves two purposes: professional reference material for work at Red Door Collaborative, and personal reference material for music discovery. All files are standalone HTML pages with no server-side dependencies — fonts load from Google Fonts, everything else is self-contained.
